...
export class addFavoritesRelationsBetweenArticlesAndUser1653853540244 implements MigrationInterface {
  name = 'addFavoritesRelationsBetweenArticlesAndUser1653853540244';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "users_favorites_articles"
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "users_favorites_articles"
        DROP CONSTRAINT "FK_61dc60abcf0035e5ce2aea013bc"`);
    await queryRunner.query(`ALTER TABLE "users_favorites_articles"
        DROP CONSTRAINT "FK_b3bc5ca3e98f5f3858dbf626ad6"`);
